...
class PagoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['fecha_pago', 'monto_crc', 'monto_usd']
...
class PagoInscripcionSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if inscripcion and data.get('monto') != inscripcion.programa.precio:
            raise serializers.ValidationError(
...
class DonacionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['fecha_creacion', 'monto_crc', 'monto_usd']
