...
from payments.models import Pago, Reembolso
from payments.services import ReembolsoService
from payments.exceptions import ReembolsoError
...
class TestReembolsoService(TestCase):
    ...
    def test_reembolso_diferentes_monedas(self):
        ...
        self.assertEqual(reembolso.moneda, 'EUR')
        self.assertEqual(reembolso.monto, self.pago.monto)
