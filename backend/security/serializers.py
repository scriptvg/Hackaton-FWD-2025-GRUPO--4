...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['username', 'email', 'phone', 'address', 'birth_date', 'profile_picture', 'bio', 'roles', 'user_roles', 'created_at', 'updated_at']
        extra_kwargs = {
...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['phone', 'address', 'birth_date', 'profile_picture', 'bio', 'roles']
        extra_kwargs = {
